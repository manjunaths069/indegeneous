...
<xsl:stylesheet
    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
           		<table class="section-header" width="100%" border="0" cellspacing="0" cellpadding="0">
	      	 		<tr>
	           			...
	           			<td align="right">
	          				<a target="_new" href="/servlets/com.proactivenet.servlet.HelpServlet?title=JVMMoreInfoDD">
         ...
         <xsl:if test='detaildiagnostics/data/jvm/deadlockthreads'>     
          
               	<br/> 	<br/>            <b> Thread Dump for Deadlock Threads </b>           <br/>         	        	<br/>
           	    <table class="data" width="100%" border="0" cellspacing="0" cellpadding="0">
         	   		<thead>
		            	<tr class="header-column first">
		                	<th align="left" class="header-column first" style="text-align:left;">
         	   		...
         	   		<tbody>	
       					<xsl:for-each select="detaildiagnostics/data/jvm/deadlockthreads/dump">
       		    			<tr class="data even">
           						<td class="data even" style="text-align:left;">
          ...
          <xsl:if test='detaildiagnostics/data/jvm/threads'>     
          
               	<br/> 	<br/>            <b>  Thread Dump for All Threads </b>           <br/>         	        	<br/>
           	    <table class="data" width="100%" border="0" cellspacing="0" cellpadding="0">
         	   		<thead>
		            	<tr class="header-column first">
		                	<th align="left" class="header-column first" style="text-align:left;">
         	   		...
         	   		<tbody>	
       					<xsl:for-each select="detaildiagnostics/data/jvm/threads/dump">
       		    			<tr class="data even">
           						<td class="data even" style="text-align:left;">
									<xsl:value-of select="cputime"/>
	    						</td>
