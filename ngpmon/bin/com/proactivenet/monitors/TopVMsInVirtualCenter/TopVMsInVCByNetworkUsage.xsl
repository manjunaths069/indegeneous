...
<xsl:stylesheet
   ...
   <body>
   		    <table class="section-header" width="100%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                               <td class="caption">
                               Top 10 VMs by Network Usage on 
			           <xsl:for-each select="detaildiagnostics/data/top/virtualcenter">
			               <xsl:value-of select="virtualcentername"/> 
        		           </xsl:for-each>
				           (
				           <xsl:for-each select="detaildiagnostics/data/top/ip">
                               ...
                               <td align="right">
                                   <a target="_new" href="/servlets/com.proactivenet.servlet.HelpServlet?title=TopVMsInVCByNetworkUsage">
    ...
    <xsl:otherwise>
      <table class="data" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr class="header-column first">
          ...
          <th class="header-column third" style="text-align: center;">Network Usage(KBps)</th>
        </tr>
