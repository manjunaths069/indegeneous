            ...
            <body>
                ...
                <table class="section-header" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td align="right">
                            <a href="/servlets/com.proactivenet.servlet.HelpServlet?title=LinuxTop10" target="_new">
                        ...
                        <td>
                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                <xsl:if test="detaildiagnostics/data/system/attribute">
                                        ...
                                        <xsl:for-each select="detaildiagnostics/data/system/attribute">
                                            <xsl:choose>
                                                <xsl:when test="position()!=1">
                                                    <td valign="top">
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            <tr class="mediumpurple" HEIGHT="15">
                                    ...
                                    <tr valign="top" class="section-header" height="18">
                                        <xsl:for-each select="detaildiagnostics/data/system/attribute">
                                            <xsl:choose>
                                                <xsl:when test="position()!=1">
                                                    <td>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <table class="data" width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <thead>
                                                <xsl:for-each
                                                    select="detaildiagnostics/data/system/process[position()=1]">
