    ...
    <xsl:template match="/">
       ...
       <xsl:value-of select="detaildiagnostics/data/definedconstant/@name/../@value" />
             <xsl:value-of select="detaildiagnostics/data/definedconstant" /> //-->
                            Top
                            <xsl:value-of select="detaildiagnostics/data/header3"/>
                            Processes by
                            <xsl:value-of select="detaildiagnostics/data/header4"/>
                            on
                            <xsl:value-of select="detaildiagnostics/data/header2"/>
                        </td>
                        <td align="right">
                            <a href="/servlets/com.proactivenet.servlet.HelpServlet?title=HPUXTop10" target="_new">
                ...
                <table class="data" width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="data even" style="text-align: left;">
                            <pre>
                                <font style="font-family:courier,monospace; font-size:10pt;">
