        ...
        <html>
            ...
            <body>
                ...
                <table class="section-header" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="caption">
                            <xsl:value-of select="detaildiagnostics/data/servlettop/definedconstant/@value"/>
                        </td>
                        <td align="right">
                            <a href="/servlets/com.proactivenet.servlet.HelpServlet?title=WebSphereTopServlet"
                               target="_new">
                ...
                <!-- <xsl:value-of select='detaildiagnostics/data/servlettop'/> //-->
                <table width="100%" border="0" cellspacing="0" cellpadding="0">

                    <tr>
                        <td>
                            <table width="100%">
                                <xsl:for-each select="detaildiagnostics/data/servlettop/summary1">
                        ...
                        <td valign="bottom">
                            <table width="100%"> -->
                                <xsl:for-each select="detaildiagnostics/data/servlettop/summary2">
                                    <xsl:for-each select="attribute">
                                        <tr>
                                            <td>
                                                <xsl:value-of select="@name"/>
                ...
                <table class="data" width="100%" cellspacing="0" cellpadding="0" border="0">
                    <thead>
                        <xsl:for-each select="detaildiagnostics/data/servlettop/details[position()=1]">
                    ...
                    <tbody>
                        <xsl:for-each select="detaildiagnostics/data/servlettop/details">
                            <tr class="data even">
                                <xsl:for-each select="attribute">
