   ...
   <body>
    <table class="section-header" width="100%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                               ...
                               <td align="right">
                                   <a target="_new" href="/servlets/com.proactivenet.servlet.HelpServlet?title=TopVMsInRPByCPUUsage">
                                       <img border="0
      ...
      <table class="data" width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr class="header-column first">
                ...
                <th class="header-column third" style="text-align: center;">CPU Usage(MHz)</th>
              </tr>
