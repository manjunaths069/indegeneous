...
Map<String,String> companies = new Hashtable<String,String>();
...
Enumeration enumeration = ((Hashtable<String,String>) companies).elements();
...
Set<String> hashtableKeysEnum = companies.keySet();
...
Enumeration hashtableValuesEnum = ((Hashtable<String,String>) companies).elements();
